...
class Control(Hermit, Minitouch, Scrcpy, MaaTouch, NemuIpc, WebGateway):
    ...
    def click_methods(self):
        return {
            ...
            'WebGateway': self.click_web_gateway,
    ...
    def long_click(self, button, duration=(1, 1.2)):
        ...
        elif method == 'WebGateway':
            self.long_click_web_gateway(x, y, duration)
        else:
    ...
    def swipe(self, p1, p2, duration=(0.1, 0.2), name='SWIPE', distance_check=True):
        ...
        elif method in ['minitouch', 'MaaTouch', 'scrcpy', 'nemu_ipc', 'WebGateway']:
